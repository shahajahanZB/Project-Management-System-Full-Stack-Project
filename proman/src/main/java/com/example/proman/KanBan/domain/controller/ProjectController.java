...
public class ProjectController {
    ...
    @PreAuthorize("hasAuthority('PROJECT_MANAGE_MEMBERS') or @projectService.isProjectOwner(#projectId)")
    ...
    @PreAuthorize("hasAuthority('PROJECT_DELETE') or @projectService.isProjectOwner(#projectId)")
